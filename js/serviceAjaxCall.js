...
function ready() {
	...
	$.ajax({
		...
		, success: function (response) {
			...
			$("#btn-form").html("<button type='button' class='btn btn-primary' onclick=\x22location.href ='form-servizi.html?id=" + GET["id"] + "'\x22>Sottoscrivi Servizio<br> Maggiori Informazioni</button>");
		}
		, error: function (request, error) {
			console.log("Error");
		}
